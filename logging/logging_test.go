...
func TestNewSimpleFileLogger(t *testing.T) {
	...
	logger.Info("info test2.", "name", "sea")
...
func TestLogLevelEnabled(t *testing.T) {
	...
	assert.True(t, ErrorEnabled(), "Err should be enabled when log level is DebugLevel")
	...
	assert.True(t, ErrorEnabled(), "Err should be enabled when log level is InfoLevel")
	...
	assert.True(t, ErrorEnabled(), "Err should be enabled when log level is WarnLevel")
	...
	assert.True(t, ErrorEnabled(), "Err should be enabled when log level is ErrorLevel")
}
