...
func ConsoleServer() string {
	return globalCfg.Sentinel.Dashboard.Server
}

func ConsolePort() uint32 {
	return globalCfg.Sentinel.Dashboard.Port
}

func HeartbeatClintIp() string {
	return globalCfg.Sentinel.Dashboard.HeartbeatClintIp
}

func HeartbeatApiPath() string {
	return globalCfg.Sentinel.Dashboard.HeartbeatApiPath
}

func HeartBeatIntervalMs() uint64 {
	return globalCfg.Sentinel.Dashboard.HeartBeatIntervalMs
}
