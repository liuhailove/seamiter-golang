...
const (
	...
	RecordLogFileName = "sea-record.log"
	GlobalCallerDepth = 4
...
var (
	DefaultDirName = filepath.Join("logs", "sea")
)
...
// GetGlobalLoggerLevel gets the sea log level
func GetGlobalLoggerLevel() Level {
	return globalLogLevel
}

// ResetGlobalLoggerLevel sets the sea log level
// Note: this function is not thread-safe.
func ResetGlobalLoggerLevel(l Level) {
	globalLogLevel = l
}

// GetGlobalLogger gets the sea global logger
func GetGlobalLogger() Logger {
	return globalLogger
}

// ResetGlobalLogger sets the sea global logger
// Note: this function is not thread-safe.
...
// DefaultLogger sea general logger
