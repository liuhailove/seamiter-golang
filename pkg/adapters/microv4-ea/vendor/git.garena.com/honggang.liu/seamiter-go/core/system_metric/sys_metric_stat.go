...
// SetSystemLoad is used for unit test, the user shouldn't call this function.
...
// SetSystemCpuUsage Note: SetSystemCpuUsage is used for unit test, the user shouldn't call this function.
...
// SetSystemMemoryUsage Note: SetSystemCpuUsage is used for unit test, the user shouldn't call this function.
